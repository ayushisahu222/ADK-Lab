...
> **Attribution:** This agent's original author is the [Google ADK Samples](https://github.com/google/adk-samples) project. I am just experimenting with it.
...
**Create the project from this sample** (replace `my-blogger-agent` with your project name):

```bash
agents-cli create my-blogger-agent -a adk@blogger-agent
```
